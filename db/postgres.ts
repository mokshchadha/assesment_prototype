...
export async function getModeratorByName(
	name: string,
): Promise<DbModerator | null> {
...
export async function getModeratorById(
	id: string,
): Promise<DbModerator | null> {
	const [row] = await sql<DbModerator[]>`
...
export async function getOpenEventsByRegion(
	region: Region,
): Promise<DbEvent[]> {
	return sql<DbEvent[]>`
    SELECT * FROM events
...
export async function getRecentEventsByRegion(
	region: Region,
): Promise<DbEvent[]> {
	return sql<DbEvent[]>`
    SELECT * FROM events
...
export async function reopenClaimedEventsByModerator(
	moderatorId: string,
): Promise<DbEvent[]> {
	return sql<DbEvent[]>`
    UPDATE events
...
export async function getClaimedEvents(
	moderatorId: string,
): Promise<DbEvent[]> {
	return sql<DbEvent[]>`
    SELECT * FROM events
...
export async function getClaimedEventsByModerator(
	moderatorId: string,
): Promise<DbEvent[]> {
	return sql<DbEvent[]>`
    SELECT * FROM events
...
export async function getResolvedEventsByModerator(
	moderatorId: string,
): Promise<DbEvent[]> {
	return sql<DbEvent[]>`
    SELECT * FROM events
