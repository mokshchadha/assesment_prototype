			...
			socket.onmessage = (e) => {
				...
				switch (msg.type) {
					case "available_events":
						opts.onAvailableEvents(msg.events, msg.lockTtlSeconds);
						break;
					case "claim_success":
						opts.onClaimSuccess(msg.event);
						break;
					case "claim_failed":
						opts.onClaimFailed(msg.eventId, msg.reason);
						break;
					case "claim_expired":
						opts.onClaimExpired(msg.eventId);
						break;
					case "ack_success":
						opts.onAckSuccess(msg.eventId);
						break;
					case "ack_failed":
						opts.onAckFailed(msg.eventId, msg.reason);
						break;
					case "error":
